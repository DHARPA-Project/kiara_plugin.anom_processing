...
"""Top-level package for kiara_plugin.anom_processing."""
...
KIARA_METADATA = {
    ...
    "description": "Kiara modules for: anom_processing",
    "references": {
        "source_repo": {
        ...
        "documentation": {
            ...
            "url": "https://DHARPA-Project.github.io/kiara_plugin.anom_processing/",
        },
    },
    "tags": ["anom_processing"],
    "labels": {"package": "kiara_plugin.anom_processing"},
}

find_modules: KiaraEntryPointItem = (
    find_kiara_modules_under,
    "kiara_plugin.anom_processing.modules",
)
find_model_classes: KiaraEntryPointItem = (
    find_kiara_model_classes_under,
    "kiara_plugin.anom_processing.models",
)
find_data_types: KiaraEntryPointItem = (
    find_data_types_under,
    "kiara_plugin.anom_processing.data_types",
)
find_pipelines: KiaraEntryPointItem = (
    find_pipeline_base_path_for_module,
    "kiara_plugin.anom_processing.pipelines",
    KIARA_METADATA,
)
