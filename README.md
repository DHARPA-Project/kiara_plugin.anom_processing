[![PyPI status](https://img.shields.io/pypi/status/kiara_plugin.anom_processing.svg)](https://pypi.python.org/pypi/kiara_plugin.anom_processing/)
[![PyPI version](https://img.shields.io/pypi/v/kiara_plugin.anom_processing.svg)](https://pypi.python.org/pypi/kiara_plugin.anom_processing/)
[![PyPI pyversions](https://img.shields.io/pypi/pyversions/kiara_plugin.anom_processing.svg)](https://pypi.python.org/pypi/kiara_plugin.anom_processing/)
[![Build Status](https://img.shields.io/endpoint.svg?url=https%3A%2F%2Factions-badge.atrox.dev%2FDHARPA-Project%2Fkiara%2Fbadge%3Fref%3Ddevelop&style=flat)](https://actions-badge.atrox.dev/DHARPA-Project/kiara_plugin.anom_processing/goto?ref=develop)
[![Coverage Status](https://coveralls.io/repos/github/DHARPA-Project/kiara_plugin.anom_processing/badge.svg?branch=develop)](https://coveralls.io/github/DHARPA-Project/kiara_plugin.anom_processing?branch=develop)
[![Code style](https://img.shields.io/badge/code%20style-black-000000.svg)](https://github.com/ambv/black)

# [**kiara**](https://dharpa.org/kiara.documentation) plugin: (anom_processing)
...
```console
git clone https://github.com/DHARPA-Project/kiara_plugin.anom_processing.git
cd kiara_plugin.anom_processing
python3 -m venv .venv
...
```console
kiara run anom_processing_example text_1="xxx" text_2="yyy"
...
...
```
...
```console
cd path/to/kiara_plugin.anom_processing
